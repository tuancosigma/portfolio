...
const metrics = [
  {
    ...
    sublabel: "Cisco, ISC2, Coursera credentials",
  },
  {
    value: 3,
    suffix: "",
    prefix: "",
    label: "Major security projects",
    sublabel: "WAF, ML detection, DB hardening",
  },
  {
    value: 2,
    suffix: "",
    ...
    sublabel: "SOC research + system administration",
  },
];
    ...
    <section ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div data-reveal className="mt-16 pt-8 border-t border-foreground/10 flex flex-wrap items-center gap-x-12 gap-y-4 text-sm font-mono text-muted-foreground">
          ...
          <span>ELK Stack</span>
          <span className="text-foreground">+12 more tools</span>
        </div>
      </div>
    </section>
  );
