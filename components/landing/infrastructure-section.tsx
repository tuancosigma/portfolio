...
const regions = [
  ...
  { name: "Network & WAF Lab", nodes: 6, status: "hands-on" },
  { name: "Infrastructure Monitoring", nodes: 7, status: "hands-on" },
  { name: "Automation & Response", nodes: 5, status: "hands-on" },
];
          ...
          <div className={`lg:col-span-2 relative p-8 lg:p-12 border border-foreground/10 bg-foreground/[0.02] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <div className="flex items-baseline gap-2 mb-4">
                ...
                <span className="text-2xl text-muted-foreground">lab domains</span>
              </div>
              <p className="text-muted-foreground max-w-md">
                From SIEM alerts to WAF tuning to Proxmox homelab ops — each domain built for repeatable, evidence-first practice.
              </p>
            </div>
          </div>
        ...
        <div className={`mt-12 grid grid-cols-2 lg:grid-cols-4 gap-4 transition-all duration-1000 delay-300 ${
          ...
          {regions.map((region, index) => (
            ...
            >
              ...
              <span className="text-sm text-muted-foreground">{region.nodes} tools</span>
            </div>
          ))}
        </div>
      </div>
