      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl text-foreground" : "text-2xl text-white"}`}>TUAN PHAM</span>
            <span className={`font-mono transition-all duration-500 ${isScrolled ? "text-[10px] mt-0.5 text-muted-foreground" : "text-xs mt-1 text-white/60"}`}>SOC</span>
          </a>
        ...
        <div className="flex flex-col h-full px-8 pt-28 pb-8">
          ...
          >
            <Button
              ...
              asChild
            >
              <a href="https://www.linkedin.com/in/tuan-pham-8abb3a335/" target="_blank" rel="noopener noreferrer">LinkedIn</a>
            </Button>
            <Button
