...
const features = [
  {
    ...
    description: "Investigate alerts across ELK, Graylog, Kibana, and Wazuh. Parse logs with regex, correlate events, and reduce noise before escalation.",
    stats: { value: "8", label: "SIEM tools & platforms" },
  },
  {
    number: "02",
    title: "Network & Security",
    description: "Configure pfSense and Barracuda WAF, review OWASP Top 10 risks, and run vulnerability assessments against real attack traffic.",
    stats: { value: "8", label: "network & security skills" },
  },
  {
    number: "03",
    title: "Offensive & Defensive Tooling",
    description: "Hands-on with Wireshark, Nmap, Burp Suite, Metasploit, and digital forensics to understand both sides of an attack.",
    stats: { value: "8", label: "tools in daily use" },
  },
  {
    number: "04",
    title: "Automation & Scripting",
    description: "Write Python scripts that parse logs, trigger SMTP/API alerts, and turn repetitive triage checks into repeatable workflows.",
    stats: { value: "4", label: "automation skills" },
  },
];
